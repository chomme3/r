...
#Note: The way you measure the outcome changes the underlying parallel trends assumption! First we run the regression in levels, then we run in logs. The PTA is different between the two.
...
#-----------------------------------------------------------------------------
# What kind of covariates "should" we include?!
