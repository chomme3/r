...
eval_lalonde_cps <- subset(ST_2005, ST_2005$treated==0 | ST_2005$sample==2)
eval_dw_cps <- subset(ST_2005, (ST_2005$dwincl==1 & ST_2005$treated==0) | ST_2005$sample==2)
eval_early_cps <- subset(ST_2005, (ST_2005$early_ra==1 & ST_2005$treated==0) | ST_2005$sample==2)
#------------------------------------------------------------------------------------------------------
